...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <div class="relative p-4 text-center bg-white rounded-lg shadow white sm:p-5">
            <button type="button"
            ...
            <form id="deleteForm" method="POST">
                ...
                <div class="flex justify-center items-center space-x-4">
                    <button type="button" onclick="closeDeleteModal()"
                        class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100">Batal</button>
                    <button type="submit"
                        class="py-2 px-3 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700">Ya,
                        Hapus</button>
                </div>
            </form>
        </div>
